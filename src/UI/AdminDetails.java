...
public class AdminDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resturant Details");
        ...
        tf_name.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        ...
        tf_email.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N

        tf_phone.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
    ...
    private void btn_commitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_commitActionPerformed
        ...
        jsonObject.put("name", tf_name.getText());
        jsonObject.put("email", tf_email.getText());
        jsonObject.put("phone", tf_phone.getText());
        jsonObject.put("address", tf_address.getText());
        
        try {
            NetworkCall networkCall = new NetworkCall(NetworkCall.POST, NetworkCall.USER_DETAILS, jsonObject);
            HttpURLConnection con = networkCall.callMethod();
            networkCall.getResponseString(con);
            if (networkCall.getResponseCode(con) == 200) {
                JFrame frame = new JFrame();
                String message = "Authenation Code";
                ...
                if (text != null) {
                    try {
                        ...
                        NetworkCall networkCallNew = new NetworkCall(NetworkCall.POST, NetworkCall.VALIDATE_USER, jsonObjectNew);
                        HttpURLConnection conNew = networkCallNew.callMethod();
                        if (networkCall.getResponseCode(conNew) == 200) {
